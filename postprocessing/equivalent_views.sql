...
CREATE VIEW q18 AS '"SELECT hidden_stories.* FROM hidden_stories WHERE hidden_stories.user_id = ? AND hidden_stories.story_id = ?"';
...
CREATE VIEW q23 AS '"SELECT taggings.* FROM taggings WHERE taggings.story_id = ?"';
